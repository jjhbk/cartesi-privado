...
export const Input: React.FC<IInputPropos> = (props) => {
  ...
  console.log(
    "abi encoded data to add is:",
    encodeFunctionData({
      abi: dappAbi,
      functionName: "addToWhiteList",
      args: ["0x08208F5518c622a0165DBC1432Bc2c361AdFFFB1"],
    })
  );
  console.log(
    "abi encoded data to add is:",
    ...
    <div>
      {
        <div>
          ...
          <button onClick={() => sendAddress()}>Send</button>
          <br />
          <br />
        </div>
      }
      ...
      <br />
      <div>
        check if you are whiteListed on the Cartesi Dapp <br />
        <button
          onClick={() => {
            setInput(
              encodeFunctionData({
                abi: dappAbi,
                functionName: "checkWhiteList",
                args: [getAddress(connectedWallet.accounts[0].address)],
              })
            );
            addInput();
          }}
      ...
      </div>
      {
        <div>
          <div>
            ...
            />
            <button onClick={() => depositEtherToPortal()}>
              Deposit Ether
            </button>
            <br />
            <br />
          ...
          <div>
            ...
            />
            <button onClick={() => depositErc20ToPortal()}>
              Deposit ERC20
            </button>
            <br />
            <br />
          ...
          <div>
            ...
            />
            <button onClick={() => transferNftToPortal()}>Transfer NFT</button>
            <br />
            <br />
          </div>
        </div>
